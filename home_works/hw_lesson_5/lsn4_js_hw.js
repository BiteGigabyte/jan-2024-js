...
//
const circleSquare = r => pi * (r * r);
console.log('Task 2: ' + circleSquare(4));


// - створити функцію яка обчислює та повертає площу циліндру висотою h, та радіутом r
//
const cylinderSquare = (h, r) => (2 * pi * r) * (r + h);
...
const createUlAndLiCyclically = (text, quantity) => {
    document.write(`<ul>`);
...
//
const arrayBlocksFunction = array => {
